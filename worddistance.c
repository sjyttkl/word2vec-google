...
int main(int argc, char **argv) {
  ...
  if(format == 1){
		...
		for (a = 0; a < size; a++) {
			...
			//�ڽ���word2vecѵ��ʱ��-binary 1 ʱ�������������vector.binΪ�����ƣ�����Ϊfloat. 
			//if(format == 1) 
			fscanf(f,"%f",&M[a + b * size]);//vector.bin Ϊfloatʱ��ֻ��ͨ��fscanf��ȡ������������
			//else
			//fread(&M[a + b * size], sizeof(float), 1, f);//vector.bin Ϊbinaryʱ��ֻ��ͨ��fread��ȡ�����������ݡ�
	...
	for (b = 0; b < words; b++) {
		...
		for (a = 0; a < size; a++) {
			// modify by hanleyzhang 20160705
			//�ڽ���word2vecѵ��ʱ��-binary 1 ʱ�������������vector.binΪ�����ƣ�����Ϊfloat. 
			//if(format == 1) fscanf(f,"%f",&M[a + b * size]);//vector.bin Ϊfloatʱ��ֻ��ͨ��fscanf��ȡ������������
			//else
			fread(&M[a + b * size], sizeof(float), 1, f);//vector.bin Ϊbinaryʱ��ֻ��ͨ��fread��ȡ�����������ݡ�
			//fread(&M[a + b * size], sizeof(float), 1, f);
		}
